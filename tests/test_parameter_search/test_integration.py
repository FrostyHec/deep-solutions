...
from deep_solutions.parameter_search import ParamSearcher, SearchResult, Timer
...
def test_submodule_imports() -> None:
    ...
    from deep_solutions.parameter_search.analyzers import (
        BaseAnalyzer,
        BestParamAnalyzer,
        ChartAnalyzer,
    )
    from deep_solutions.parameter_search.epochs import simple_epoch, timed_epoch
